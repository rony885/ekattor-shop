...
const ProductTranding = () => {
  ...
  const PrevArrow = ({ className, style, onClick }) => (
    <button
      className={`swiper-prev swiper-prev-Trending ${className}`}
      style={{ ...style }}
      onClick={onClick}
    >
      <span>
  ...
  const NextArrow = ({ className, style, onClick }) => (
    <button
      className={`swiper-next swiper-next-Trending ${className}`}
      style={{ ...style }}
      onClick={onClick}
    >
      <span>
                    ...
                    {products.map((product) => (
                      <div key={product.id} className="single-product-wrap">
                        <div className="product-image">
                          <Link to="/product-details" className="pro-img">
                            <img
                              src={product.img1}
...
const Wrapper = styled.section`
  ...
  /* Ensure actions always visible on medium/small screens */
